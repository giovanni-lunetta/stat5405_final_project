...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(disp.est }\OtherTok{\textless{}{-}}\NormalTok{ reduced\_model}\SpecialCharTok{$}\NormalTok{deviance}\SpecialCharTok{/}\NormalTok{reduced\_model}\SpecialCharTok{$}\NormalTok{df.residual)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mse }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((test\_data}\SpecialCharTok{$}\NormalTok{Yards }\SpecialCharTok{{-}}\NormalTok{ predicted\_yards)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
\NormalTok{mse}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mae }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(}\FunctionTok{abs}\NormalTok{(test\_data}\SpecialCharTok{$}\NormalTok{Yards }\SpecialCharTok{{-}}\NormalTok{ predicted\_yards))}
\NormalTok{mae}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{project_report_files/figure-pdf/unnamed-chunk-35-1.pdf}
...
{\centering \includegraphics{project_report_files/figure-pdf/unnamed-chunk-41-1.pdf}
